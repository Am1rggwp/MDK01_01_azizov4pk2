...
namespace PZ_14
{
    public partial class MainWindow : Window
    {
        ...
        private void AddTextBoxesForStudent(Student student)
        {
            ...
            // Текстовое поле для средней оценки
            //var averageGradeTextBox = new TextBox
            //{
            //    Text = student.AverageGrade.ToString("F2"),
            //    FontSize = 16,
            //    TextAlignment = TextAlignment.Center
            //};

            //Grid.SetRow(averageGradeTextBox, rowIndex);
            //Grid.SetColumn(averageGradeTextBox, columnIndex);
            //gradeTextBoxes.Add(averageGradeTextBox);
            //myGrid.Children.Add(averageGradeTextBox);
